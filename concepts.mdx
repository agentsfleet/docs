...
<AccordionGroup>
  <Accordion title="Run">
    One end-to-end execution of the agent on one trigger: webhook arrives → agent reasons → tool calls → result. Most zombies finish a run in a few seconds. See [How long does a run take?](/concepts/context-lifecycle).
  </Accordion>
