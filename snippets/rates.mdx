...
export const EVENT_RATE = "$0.01"; // also hardcoded in changelog.mdx (historical entries) — bump both
export const STAGE_RATE = "$0.10"; // also hardcoded in changelog.mdx (historical entries) — bump both
