...
`doctor` performs three checks and exits non-zero if any fails. It does **not** require authentication and never short-circuits — every check completes and reports:
