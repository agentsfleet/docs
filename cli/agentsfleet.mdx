...
| `agentsfleet whoami` | Shows the person, tenant, and credential this computer is signed in as. |
| `agentsfleet auth status` | Shows where the credential came from, the API URL it targets, and whether the server accepts it. |
