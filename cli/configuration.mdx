...
| `AGENTSFLEET_API_KEY` | Service auth (machine-bound). Sent as the bearer and **overrides a stored `login` session**. Use this for CI, service-to-service calls, and external fleets (LangGraph, CrewAI, Composio, your own code). | — |
