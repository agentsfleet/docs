...
<Step title="Verify the registered webhook">
  ...
  The agent filters incoming payloads for `conclusion=failure` on a production-branch workflow — the rule lives in the generated `.usezombie/platform-ops/SKILL.md` and is editable. See [Authoring](/zombies/authoring) to widen or narrow it.
...
<Columns cols={2}>
  <Card title="Steer the agent manually" icon="message" href="/cli/zombiectl">
