...
<Step title="Sign in">
  ...
  Opens a Clerk OAuth flow in your browser. New accounts come with a {STARTER_CREDIT} starter credit pool — never expires, covers both hosted execution and inference against the platform-managed default model.
