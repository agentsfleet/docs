...
23 tools are user-callable today. They group into nine categories below. For the file format, validation rules, and frontmatter, see [Authoring an agent](/zombies/authoring).
...
- [Authoring an agent](/zombies/authoring) — full `TRIGGER.md` schema.
...
- [Webhooks](/zombies/webhooks) — wiring an external system to your agent.
