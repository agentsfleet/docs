...
| `kill <zombie_id>` | Mark terminal. The agent won't process events again, but its row, history, and webhook URL persist. | No, but a killed agent can be `delete`d after. |
