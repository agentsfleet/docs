> **Generated by `orly`.**
> Profile: `mintlify-docs`. Ruleset digest: `4da90d903f2e186d89b1603a7444d3b82423995d9674afabed3f93aeb4b7ffa5`.
...
| `domain.changelog` | path or action trigger |
...
|---|---|
| `conform` | `make lint` |
| `verify.documentation` | `make test` |
