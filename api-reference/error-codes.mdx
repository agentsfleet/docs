...
| `UZ-AUTH-014` | 410 | Login session not approved | Not yet approved in the dashboard |
...
| Code | HTTP | Title | Common Causes |
|---|---|---|---|
| `UZ-AGENT-001` | 404 | Agent key not found | Agent key not found. Verify the `agent_key_id`. |
