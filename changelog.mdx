...
<Update label="Jul 05, 2026" tags={["Bug fixes", "UI", "API"]}>
  ...
  - **API Keys page** — the sidebar's "Workspace" entry is now "API Keys"; the page shows your workspace name and ID alongside your keys. `/settings` redirects here. The Workspace tab and its "Manage workspace" menu item are gone — switching and creating a workspace stay in the top-right workspace switcher, which now reads "Create workspace".
