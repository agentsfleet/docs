...
<Update label="Jul 11, 2026" tags={["What's new", "API", "CLI", "Integrations"]}>
  ...
  - `POST /v1/ingress/github` verifies the platform GitHub App signature, acknowledges signed `ping` checks, maps `installation.id` to a workspace, normalizes supported events, and returns `202` after routing matching fleets.
