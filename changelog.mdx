...
<Update label="Jul 17, 2026" tags={["Bug fixes", "UI"]}>
  ...
  - **A Platform sidebar group** — **Runners**, **Model library**, and **Fleet library** move out of the Configuration list into their own **Platform** group, shown to an operator holding the matching scope. The group is open by default and can be collapsed.
</Update>
