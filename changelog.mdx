...
<Update label="Sep 07, 2026" tags={["Internal", "Performance"]}>
  ...
  - **Delivery head-of-line** — with one destination in sixteen answering in 250 ms, the other fifteen's p95 rose to 3.7 s: one stream, one worker, one queue position at a time.
