...
<Update label="May 9, 2026" tags={["Breaking", "What's new", "API", "UI"]}>
  ...
  - **One billing flow on `usezombie.com/#pricing`** — horizontal diagram: event cell ({EVENT_RATE}) → N stage cells ({STAGE_RATE}) → separate LLM stratum proving your model bill is not ours. Worked example: 100 events × 3 stages = $31.00.
