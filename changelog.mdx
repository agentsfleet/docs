...
<Update label="Jun 11, 2026" tags={["Bug fixes", "Observability", "Internal"]}>
  ## Evening release — billing audit rows now always equal the wallet drain
