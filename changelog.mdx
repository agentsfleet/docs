...
<Update label="May 17, 2026" tags={["Server", "Performance"]}>
  ## M69_004 Redis pool — lifts the single-mutex throughput cap
  ...
  - **Pool metrics on `/metrics`** — 8 new Prometheus series: `zombie_redis_pool_dials_total`, `overflow_dials_total`, `poisoned_connections_total`, `reconnects_total`, `forced_closes_total`, `acquire_timeouts_total`, `idle`, `acquire_wait_ns_p99`.
