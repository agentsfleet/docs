...
<Update label="Jul 21, 2026" tags={["What's new", "UI"]}>
  ...
  - **Chat survives connection loss** — messages wait while the fleet is busy, reconnecting, or offline. Missed activity returns after recovery, with manual retry when needed.
