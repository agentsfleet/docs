...
<Update label="Jun 12, 2026" tags={["What's new", "Breaking", "API"]}>
  ...
  - **Expiry is visible, not silent** — each push's server log line reports how many expired rows were swept alongside the existing stored/skipped/evicted counts.
