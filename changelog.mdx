...
<Update label="May 9, 2026" tags={["What's new", "UI"]}>
  ...
  An end-to-end browser harness running the dashboard against `api-dev` is in progress; once green, the next entry will reference it as the verification anchor for everything described above.
</Update>
