...
<Update label="Jul 07, 2026" tags={["UI"]}>
  ## Dashboard cards read crisper, and the Billing usage table keeps its header in view

  Cards and tables across the dashboard now have a slightly more defined edge at rest instead of only on hover, and the Billing usage history table pins its column headers while you scroll a long list.
