...
<Update label="Jul 17, 2026" tags={["Bug fixes", "UI"]}>
  ...
  - **A Platform sidebar group** — **Runners**, **Model library**, and **Fleet library** move out of the Configuration list into their own **Platform** group, shown only to an operator holding the matching scope. The group is collapsed by default; expand it to reach the surfaces.
</Update>
