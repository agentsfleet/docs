...
<Update label="Sep 16, 2026" tags={["Bug fixes", "API"]}>
  ...
  - **Runner polls** — a fleet with an unreadable configuration answers the documented no-work response instead of `500` `UZ-INTERNAL-003`. The runner moves on and takes the next fleet.
