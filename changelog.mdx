...
<Update label="Sep 16, 2026" tags={["API"]}>
  ...
  - **`operation_id`** — an optional string on the steer body, your own name for the operation, repeated across its retries. A retry carrying a value already seen is answered with the first attempt's event rather than starting a second run.
