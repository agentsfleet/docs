...
On screens at least 640px wide, the dashboard header shows what is left of that balance on every page, as a **Credits** chip beside the workspace switcher. Select the chip to open **Settings → Billing**, which holds the live figure and the charge history.
