...
A connected Slack workspace also lets a fleet answer mentions in a channel. That needs no grant, because `agentsfleet` posts the answer itself. See [Answer mentions in Slack](/fleets/slack).
