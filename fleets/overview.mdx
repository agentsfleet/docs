...
Everything in this section of the docs is about working with fleets: how to install one from the Fleet library, how to start and stop it, how to attach credentials, how webhooks reach it, and how to author the `SKILL.md` and `TRIGGER.md` files that define its behavior.
...
- **Secrets** — the vault that fleets read from when they invoke tools. See [Secrets & ENVs](/fleets/secrets).
...
<CardGroup cols={2}>
  ...
  <Card title="Secrets & ENVs" icon="key" href="/fleets/secrets">
