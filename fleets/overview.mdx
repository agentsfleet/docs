...
Chat retries a lost connection quickly at first, with delays from two to 15 seconds. It then reports the feed as not live and keeps retrying every 30 seconds. It also reconnects as soon as the tab returns to the foreground or the network comes back.
