...
A connection attempt that stalls for 30 seconds is retried. Chat also retries an open connection after 45 seconds without activity or a server heartbeat to recover from silent network failures.
