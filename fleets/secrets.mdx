...
To replace a value, delete the secret and create it again. See [Remove or undo](#remove-or-undo).
...
This delete-then-create pair is also how you rotate a value. There is no overwrite flag.
